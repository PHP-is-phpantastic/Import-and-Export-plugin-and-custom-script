 ...
 * @since 3.5.9 Tweak : show error if session file is not writable.
 */
function init_session() {
        ...
        if( !is_writable($session_path) ) {
                add_sitewide_notices('Session file is not writable','danger');
        }
...
// IMPORTANT: edit classes/class-feedsync-upgrade.php and add version.
$current_version    = '3.5.9';
$build_number       = '22-0512';
 ...
 *
 * @since 3.4.0
 * @since 3.5.9 Tweak: Removed force utf8 database encoding requirement.
 */
...
/**
 * Reset FS tables on reset
 * 
 * @since 3.5.8 empty listing meta table
 *
 * @return void
 */
function reset_feedsync_table() {
    ...
    $status_listing_meta        =  fsdb()->query("TRUNCATE TABLE ".fsdb()->listing_meta."");
...
/**
 * Get Listing ID by FS Unique ID
 * @param  array
 * @since 3.5.8
 * @return int
 */
function get_listing_id_by_fs_unique_id( $fs_unique_id ) {

        $listing = fsdb()->get_row("select * from ".fsdb()->listing." where feedsync_unique_id = '{$fs_unique_id}' ");
